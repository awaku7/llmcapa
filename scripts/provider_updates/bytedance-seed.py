"""Audit Structured Outputs for bytedance-seed only."""
...
DATA = ROOT / "src/llmcapa/data/bytedance-seed.json"
...
def main():
    ...
    LOG.write_text(
        ...
        + "\n## bytedance-seed Structured Outputs audit ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models; documented={DOCUMENTED}.\n",
        encoding="utf-8",
    )
    print("bytedance-seed: structured outputs audited", n)
