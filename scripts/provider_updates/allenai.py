"""Audit Structured Outputs for allenai only."""
...
DATA = ROOT / "src/llmcapa/data/allenai.json"
LOG = ROOT / "provider_update_log.md"
SOURCE = "https://docs.allenai.org/"
DOCUMENTED = False
...
def main():
    ...
    LOG.write_text(
        ...
        + "\n## allenai Structured Outputs audit ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models; documented={DOCUMENTED}.\n",
        encoding="utf-8",
    )
    print("allenai: structured outputs audited", n)
