"""Audit Structured Outputs for llama_cpp only."""
...
DATA = ROOT / "src/llmcapa/data/llama_cpp.json"
...
def main():
    ...
    LOG.write_text(
        ...
        + "\n## llama_cpp Structured Outputs audit ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models; documented={DOCUMENTED}.\n",
        encoding="utf-8",
    )
    print("llama_cpp: structured outputs audited", n)
