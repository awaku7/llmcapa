"""Audit Structured Outputs for cognitivecomputations only."""
...
DATA = ROOT / "src/llmcapa/data/cognitivecomputations.json"
LOG = ROOT / "provider_update_log.md"
SOURCE = "https://huggingface.co/cognitivecomputations"
DOCUMENTED = False
...
def main():
    ...
    LOG.write_text(
        ...
        + "\n## cognitivecomputations Structured Outputs audit ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models; documented={DOCUMENTED}.\n",
        encoding="utf-8",
    )
    print("cognitivecomputations: structured outputs audited", n)
