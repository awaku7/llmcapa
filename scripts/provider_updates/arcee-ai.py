"""Audit Structured Outputs for arcee-ai only."""
...
DATA = ROOT / "src/llmcapa/data/arcee-ai.json"
LOG = ROOT / "provider_update_log.md"
SOURCE = "https://docs.arcee.ai/"
DOCUMENTED = False
...
def main():
    ...
    LOG.write_text(
        ...
        + "\n## arcee-ai Structured Outputs audit ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models; documented={DOCUMENTED}.\n",
        encoding="utf-8",
    )
    print("arcee-ai: structured outputs audited", n)
