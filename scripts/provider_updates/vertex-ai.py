"""Update endpoint metadata for the vertex-ai provider only."""
...
DATA = ROOT / "src/llmcapa/data/vertex-ai.json"
...
def main():
    ...
    LOG.write_text(
        ...
        + f"\n## vertex-ai endpoint metadata refresh ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models.\n",
        encoding="utf-8",
    )
    print("vertex-ai: endpoint metadata updated", n)
