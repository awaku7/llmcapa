"""Audit Structured Outputs for poolside only."""
...
DATA = ROOT / "src/llmcapa/data/poolside.json"
...
def main():
    ...
    LOG.write_text(
        ...
        + "\n## poolside Structured Outputs audit ({datetime.now(timezone.utc).date()})\n\n- Source: {SOURCE}\n- Updated: {n} models; documented={DOCUMENTED}.\n",
        encoding="utf-8",
    )
    print("poolside: structured outputs audited", n)
