"""Update the fireworks catalog from its official model page only."""
import json,re
...
PATTERN='(?:accounts/[^\\s"\\\']+/models/)?(?:deepseek|qwen|kimi|glm|minimax|openai|llama|mixtral|mistral|yi|phi|gemma)[a-zA-Z0-9._:/-]+'
def fetch():
...
def update_endpoints():
 ...
 LOG.write_text(LOG.read_text(encoding="utf-8")+f"\n## fireworks endpoint metadata refresh ({date.today()})\n\n- Source: {SOURCE}\n- Updated: {n} models.\n",encoding="utf-8")
 print("fireworks: endpoint metadata updated",n)
