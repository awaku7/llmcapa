...
VIDEO_PRICES = {
    "bytedance/seedance-2.5": {"online_cny_per_1m": {"480p_720p_no_input_video": 70.0, "480p_720p_input_video": 42.0, "1080p_no_input_video_listed": 77.0, "1080p_input_video_listed": 46.0}},
    "bytedance/seedance-2.0": {"online_cny_per_1m": {"480p_720p_no_input_video": 46.0, "480p_720p_input_video": 28.0, "1080p_no_input_video": 51.0, "1080p_input_video": 31.0, "4k_no_input_video": 26.0, "4k_input_video": 16.0}},
    "bytedance/seedance-2.0-fast": {"online_cny_per_1m": {"480p_720p_no_input_video_listed": 37.0, "480p_720p_input_video_listed": 22.0}},
    "bytedance/seedance-2.0-mini": {"online_cny_per_1m": {"480p_720p_no_input_video_listed": 23.0, "480p_720p_input_video_listed": 14.0}},
    "bytedance/seedance-1-5-pro": {"online_cny_per_1m": {"audio_video": 16.0, "silent_video": 8.0}, "batch_cny_per_1m": {"audio_video": 8.0, "silent_video": 4.0}},
}
...
def main() -> None:
    ...
    if len(text) < 1000:
        raise RuntimeError("Volcengine official pricing page returned insufficient content")
    ...
    for model in data.get("models", []):
        ...
        extra.update({"official_source": SOURCE, "official_source_checked_at": today, "official_spec_refresh": "parsed", "pricing_currency": "CNY", "official_video_pricing": VIDEO_PRICES[mid]})
        updated += 1
