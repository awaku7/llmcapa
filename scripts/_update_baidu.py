...
def main() -> None:
    ...
    with urlopen(req, timeout=30) as response:
        text = response.read(800_000).decode("utf-8", "ignore")
    ...
    for model in data.get("models", []):
        ...
        extra.update({"official_source": SOURCE, "official_source_checked_at": today, "official_spec_refresh": "parsed", "official_featured_models": FEATURED, "pricing_status": "official Qianfan price page not parsed"})
        updated += 1
